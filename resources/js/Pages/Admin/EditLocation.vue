...
const form = useForm({
  ...
  douches: location.douches,
  wc: location.wc,
  descriptionshort: location.court_description,
  loyer: location.loyer,
  pays: location.pays,
  ville: location.ville,
  zone: location.zone,
  avances: location.avances,
  prepayes: location.prepayes,
  cautions: location.cautions,
  commission: location.commission,
  descriptionlong: location.longue_description,
  images: [],
});
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        >
          <div class="p-6 text-gray-900 dark:text-gray-100">
            <h4>Modification de la location <span class="text-xl text-sm">{{ location.type }}</span></h4>
            <br />
            ...
            <form @submit.prevent="submit">
              <div v-if="currentStep == steps.TYPELOCATION" class="p-5">
                ...
                <select
                  v-model="form.type"
                  id=""
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.type" selected>{{ form.type }}</option>
              ...
              <div v-if="currentStep == steps.INFOS" class="p-5">
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.pieces" selected>{{ form.pieces }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.cuisine" selected>{{ form.cuisine }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.douches" selected>{{ form.douches }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.wc" selected>{{ form.wc }}</option>
              ...
              <div v-if="currentStep == steps.LOCALISATION" class="p-5">
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.pays" selected>{{ form.pays }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.ville" selected>{{ form.ville }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.zone" selected>{{ form.zone }}</option>
              ...
              <div v-if="currentStep == steps.DESCRIPTIONCOURT" class="p-5">
                ...
                <textarea
                  ...
                  cols="30"
                  rows="10"
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5">  </textarea>
                <span
              ...
              <div v-if="currentStep == steps.CONDITIONS" class="p-5">
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.avances" selected>{{ form.avances }}</option>
                ...
                <select
                  ...
                  class="rounded shadow bg[#f3f4f6] block p-2 w-full focus:ring-blue-500 focus:border-5"
                >
                  <option :value="form.commission" selected>{{ form.commission }}</option>
                  <option value="">
