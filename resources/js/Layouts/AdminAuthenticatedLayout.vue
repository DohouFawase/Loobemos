            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('addZone.index')" :active="route().current('addZone')">
                                    nouvelle zone
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('newLocation.index')" :active="route().current('newLocation')">
                                    nouvelle location
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('reservation.index')" :active="route().current('reservation')">
                                    reservation
                                </NavLink>
                            </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('addZone.index')" :active="route().current('addZone')">
                            Nouvelle Zone
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('newLocation.index')" :active="route().current('newLocation')">
                            Nouvelle Location
                        </ResponsiveNavLink>
                    </div>
